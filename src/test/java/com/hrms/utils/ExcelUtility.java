...
public class ExcelUtility {
	...
	public static int rowCount() { // what is row count (1-3). need to know when is the end and when is the
									// start.return method
	...
	// 3. by now you know when to get to excel and count row and column. by now you
	// have the backbone. skeleton
